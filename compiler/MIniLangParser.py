...
def serializedATN():
    return [
        4,1,13,54,2,0,7,0,2,1,7,1,2,2,7,2,2,3,7,3,2,4,7,4,1,0,1,0,1,0,5,
        ...
        0,16,18,1,0,0,0,17,15,1,0,0,0,18,19,5,13,0,0,19,1,1,0,0,0,20,23,
        3,4,2,0,21,23,3,6,3,0,22,20,1,0,0,0,22,21,1,0,0,0,23,3,1,0,0,0,24,
...
class MIniLangParser ( Parser ):
    ...
    ruleNames =  [ "program", "statement", "assing", "print", "expr" ]
    ...
    class ProgramContext(ParserRuleContext):
        ...
        def EOP(self):
            return self.getToken(MIniLangParser.EOP, 0)
    ...
    class StatementContext(ParserRuleContext):
        ...
        def assing(self):
            return self.getTypedRuleContext(MIniLangParser.AssingContext,0)
    ...
    class AssingContext(ParserRuleContext):
        ...
        def getRuleIndex(self):
            return MIniLangParser.RULE_assing
    ...
    def assing(self):
        ...
        localctx = MIniLangParser.AssingContext(self, self._ctx, self.state)
